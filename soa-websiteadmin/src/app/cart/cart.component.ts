...
export class CartComponent implements OnInit {
  ...
  orders: any = [
    {
      id: '1',
      customer: 'dulshan',
      items: 'Jaipan Fruttica Mixer Grinder With 4 Jars(abans),  i6(softlogic)',
      shops: 'softlogic, abans',
      subtotal: '77500',
    },
    {
      id: '2',
      customer: 'kanishka',
      items: 'ABANS Double Burner Gas Cooker(abans)',
      shops: 'abans',
      subtotal: '7990',
    },
  ];
  ...
  moredetail(itemid) {
    // this.router.navigate(['/route-viewordder?id='+itemid]);
    console.log('on developping order ' + itemid + ' detail page');
  }
  getcartitemcount() {
    const exitcart = sessionStorage.getItem('cart');
    let ic = 0;
